fcn_simul_VARMA11_LTY  <- function(  scaleVset, option  ,   fixedeffect  ,  KFfit, MM, simulnumber){  
...
for (iii in seq(1,MM)){
  ...
  yt = fcn_VARMA11_LTY_random_data( scaleVset=scaleVset, option=option, KFfit=KFfit, fixedeffect=fixedeffect)
  ...
  filename = sprintf("theta_sim_VARMA_MLE%s%d.Rdata", temp, simulnumber) 
