...
fcn_varphiphihat_imp_rho_FE_cal <- function(calibpar,NN) { 
  ...
  temp_nonNA_idx_numeric = seq(1,length(yearqtr_xaxis))[ !is.na(var_est_phi) ]
  
  for (ii in  temp_nonNA_idx_numeric ) {
