fcn_VARMA11_LTY_random_data<- function(scaleVset, option , KFfit, fixedeffect) {
  ...
  {  
      ...
      {    
        ...
        # updated on 6/26/2014
        ytsim1[ii] = KFfit$par["mue"] + KFfit$par["phi"]*ytsim1[ii-1] + et_sim[ii] + at_sim[ii] - KFfit$par["phi"]*at_sim[ii-1]
